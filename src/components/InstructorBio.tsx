            ...
            <div className="container mx-auto px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <img
                        src="/Tj.jpg"
                        alt="Tj Cichecki"
                        className="w-48 h-48 rounded-full mx-auto mb-8 object-cover border-4 border-[#FFC107]/20 shadow-xl"
                    />
                    ...
                    <div className="text-left space-y-6">
                        ...
                        <p className="text-base text-[#FFC107] border-l-2 border-[#FFC107] pl-4 italic" style={{ fontFamily: "'DM Mono', monospace" }}>
