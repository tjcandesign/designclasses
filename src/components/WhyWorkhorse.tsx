    ...
    return (
        <section className="py-24 bg-[#0a0a0a] text-white border-t border-gray-800">
            <div className="container mx-auto px-6">
                ...
                >
                    <motion.div variants={itemVariants} className="bg-[#1a1a1a] p-8 border border-gray-800 hover:border-[#FFC107] transition-colors duration-300 shadow-2xl rounded-lg">
